...
<head>
  ...
  <title>Nilai Sub Kriteria</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Nilai Sub Kriteria</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="beranda">Beranda</a></li>
              <li class="breadcrumb-item"><a href="#">Data Kriteria</a></li>
              <li class="breadcrumb-item active">Nilai Sub Kriteria</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <?php
          $data_kriteria = $this->db->query("SELECT * FROM kriteria")->result();
          foreach ($data_kriteria as $value) {
          ?>
          <div class="col-lg-4">
            <div class="card card-outline card-teal">
              <div class="card-header">
                <h5 class="m-0"><?= $value->nama_kriteria ?></h5>
              </div>
              <div class="card-body">
                <table id="testTable" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php 
                    $no = 1;
                    $data_masternilai = $this->db->query("SELECT * FROM masternilai WHERE id_kriteria = '$value->id_kriteria'")->result(); 
                    foreach ($data_masternilai as $value2) {
                    ?>
                    <tr>
                      <td><?= $no++; ?></td>
                      <td><?= $value2->nama_nilai; ?></td>
                      <td><?= $value2->nilai; ?></td>
                    </tr>
                    <?php } ?>
                  </tbody>
